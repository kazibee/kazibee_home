...
CREATE TABLE IF NOT EXISTS connect_desktop_devices (
...
CREATE INDEX IF NOT EXISTS idx_connect_desktop_devices_owner_state
  ON connect_desktop_devices(owner_user_id, state, created_at);
