CREATE TABLE connect_executor_claims (
  ...
  executor_id TEXT NOT NULL UNIQUE REFERENCES connect_executors(executor_id) ON DELETE CASCADE,
...
CREATE INDEX idx_connect_executor_claims_status_expiry ON connect_executor_claims(status, expires_at);
