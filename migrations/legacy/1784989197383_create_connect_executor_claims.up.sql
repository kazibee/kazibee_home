CREATE TABLE IF NOT EXISTS connect_executor_claims (
...
CREATE INDEX IF NOT EXISTS idx_connect_executor_claims_status_expiry
  ON connect_executor_claims(status, expires_at);
